 ...
 *
 * KENDİ MODÜLÜNDE DURUR. Rozetler daha önce `oxfordWords.ts` içindeydi;
 * `storageV2` yalnızca rozetleri kullanmak için o dosyayı içe aktarıyor,
 * dosya da Oxford sözlüğünün tamamını yanında sürüklüyordu. Beş megabaytlık
 * sözlük, yedi rozeti okumak için açılışta ayrıştırılıyordu.
 *
