        ...
        {profile.isLoggedIn && authStep !== 'guest_migration' ? (
          <div className="space-y-5 text-center pt-2">
            ...
            <div className="flex flex-col gap-2 pt-1">
              <button
                onClick={onSyncNow}
                className="w-full py-2.5 bg-[var(--primary)] hover:bg-[var(--primary-hover)] text-[var(--surface)] font-semibold text-xs rounded-xl shadow-xs transition-colors cursor-pointer"
              >
          ...
          <div className="space-y-4">
            ...
            <form onSubmit={handleVerifyCodeSubmit} className="space-y-3.5">
              ...
              <button
                ...
                className="w-full py-2.5 bg-[var(--primary)] hover:bg-[var(--primary-hover)] disabled:opacity-50 text-[var(--surface)] font-semibold text-xs rounded-xl shadow-xs transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
              >
                {isLoading ? (
                  <>
          ...
          <div className="space-y-3.5">
            ...
            <form onSubmit={handleEmailFormSubmit} className="space-y-3">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full mt-2 py-2.5 bg-[var(--primary)] hover:bg-[var(--primary-hover)] disabled:opacity-50 text-[var(--surface)] font-semibold text-xs rounded-xl shadow-xs transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
              >
                {isLoading ? (
                  <>
                    <Loader2 className="w-3.5 h-3.5 animate-spin" />
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2.5 pt-1">
              ...
              <button
                ...
                className="w-full py-2.5 px-4 bg-[var(--primary)] hover:bg-[var(--primary-hover)] text-[var(--surface)] font-semibold text-xs rounded-xl shadow-xs transition-colors flex items-center justify-center gap-2 cursor-pointer"
              >
