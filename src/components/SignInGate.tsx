  ...
  <div className="max-w-lg mx-auto animate-fadeIn pb-safe-nav">
    <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-7 space-y-5 text-center">
      ...
      <button
        type="button"
        onClick={onOpenAuth}
        className="dugme-birincil w-full py-3 bg-[var(--primary)] hover:bg-[var(--primary-hover)] text-[var(--on-primary)] text-sm font-bold rounded-xl transition-colors cursor-pointer inline-flex items-center justify-center gap-2"
      >
